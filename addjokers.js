let tools = [
  {
    name: "Dual Calculator",
    text: [
      "So I made a board game version of Balatro, and here's how I calculate the scores"
    ],
    image_url: "img/dual_calculator.png",
    rarity: "None"
  },
  {
    name: "Mod Viewer",
    text: [
      "Many Balatro mods don't have a proper wiki, so here's a tool that generates one for a github repo."
    ],
    image_url: "img/mod_viewer.png",
    rarity: "None"
  },
]
...
let rarities = {
  ...
  "Boss Blind": "#5d5dff",
  "Showdown": "#4584fa",
  "None": "rgba(0, 0, 0, 0); display: none;"
}
...
if (tools.length === 0) {
  document.querySelector(".toolsfull").style.display = "none"
} else {
  let tools_div = document.querySelector(".tools");
  add_cards_to_div(tools, tools_div);
}
